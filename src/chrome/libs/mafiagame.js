...
(function(G) {
    function $($, pa) {
        ...
        function q(a) {
            return function(d) {
                var e = this._s;
                !e || !e._a ? (e && e.id ? c._wD(l + "ignoring " + d.type + ": " + e.id) : c._wD(l + "ignoring " + d.type),
                d = null) : d = a.call(this, d);
                return d
            }
        }
        this.setupOptions = {
        ...
        this.useAltURL = !Q;
        Ha && (c.useHTML5Audio = !0,
        c.preferFlash = !1,
        Ea && (H = c.ignoreFlash = !0));
        var Ka;
        try {
        ...
        this.createSound = function(a, d) {
            ...
            if (s(f.id, !0))
                ...
                c.sounds[f.id];
            ma(f) ? (b = e(),
            c._wD("Creating sound " + f.id + ", using HTML5"),
            b._setup_html5(f)) : (8 < k && (null === f.isMovieStar && (f.isMovieStar = !(!f.serverURL && !(f.type && f.type.match(fb) || f.url.match(mb)))),
            f.isMovieStar && (c._wD("soundManager.createSound(): using MovieStar handling"),
            1 < f.loops && m("noNSLoop"))),
            f = ja(f, "soundManager.createSound(): "),
            b = e(),
            8 === k ? g._createSound(f.id, f.loops || 1, f.usePolicyFile) : (g._createSound(f.id, f.url, f.usePeakData, f.useWaveformData, f.useEQData, f.isMovieStar, f.isMovieStar ? f.bufferTime : !1, f.loops || 1, f.serverURL, f.duration || null, f.autoPlay, !0, f.autoLoad, f.usePolicyFile),
            f.serverURL || (b.connected = !0,
            f.onconnect && f.onconnect.apply(b))),
        ...
        this.start = this.play = function(a, d) {
            var e = !1;
            return !n || !c.ok() ? (P("soundManager.play(): " + p(!n ? "notReady" : "notOK")),
            e) : !s(a) ? (d instanceof Object || (d = {
                url: d
            }),
            d && d.url && (c._wD('soundManager.play(): attempting to create "' + a + '"', 1),
            d.id = a,
        ...
        this.onready = function(a, d) {
            if ("function" === typeof a)
                n && c._wD(p("queue", "onready")),
                d || (d = i),
                ua("onready", a, d),
                J();
            else
                throw p("needFunction", "onready");
            return !0
        }
        ;
        this.ontimeout = function(a, d) {
            if ("function" === typeof a)
                n && c._wD(p("queue", "ontimeout")),
                d || (d = i),
                ua("ontimeout", a, d),
                J({
                    type: "ontimeout"
                ...
                throw p("needFunction", "ontimeout");
            return !0
        }
        ;
        this._wD = this._writeDebug = function(a, d, e) {
            ...
            try {
                ...
                d && (2 <= d && (f.style.fontWeight = "bold"),
                3 === d && (f.style.color = "#ff3333"));
        ...
        this._debug = function() {
            ...
            m("currentObj", 1);
            a = 0;
            for (d = c.soundIDs.length; a < d; a++)
                c.sounds[c.soundIDs[a]]._debug()
        }
        ;
        ...
        ;
        La = function(a) {
            var d, e, b = this, f, j, x, h, i, n, q = !1, z = [], r = 0, u, v, t = null;
            e = d = null;
            ...
            this._debug = function() {
                if (c.debugMode) {
                    var a = null, d = [], e, f;
                    for (a in b.options)
                        null !== b.options[a] && ("function" === typeof b.options[a] ? (e = b.options[a].toString(),
                        e = e.replace(/\s\s+/g, " "),
                        f = e.indexOf("{"),
                        d.push(" " + a + ": {" + e.substr(f + 1, Math.min(Math.max(e.indexOf("\n") - 1, 64), 64)).replace(/\n/g, "") + "... }")) : d.push(" " + a + ": " + b.options[a]));
            ...
            this.load = function(a) {
                var d = null;
                void 0 !== a ? b._iO = w(a, b.options) : (a = b.options,
                b._iO = a,
                t && t !== b.url && (m("manURL"),
                b._iO.url = b.url,
                b.url = null));
                ...
                if (a.url === b.url && 0 !== b.readyState && 2 !== b.readyState)
                    return m("onURL", 1),
                    3 === b.readyState && a.onload && a.onload.apply(b, [!!b.duration]),
                    b;
                b.loaded = !1;
                b.readyState = 1;
                b.playState = 0;
                ...
                if (ma(a))
                    d = b._setup_html5(a),
                    d._called_load ? c._wD(l + "ignoring request to load again: " + b.id) : (c._wD(l + "load: " + b.id),
                    b._html5_canplay = !1,
                    b.url !== a.url && (c._wD(m("manURL") + ": " + a.url),
                    b._a.src = a.url,
                    b.setPosition(0)),
                    ...
                    try {
                        ...
                        b._iO = ja(ia(a)),
                        a = b._iO,
                        8 === k ? g._load(b.id, a.url, a.stream, a.autoPlay, a.usePolicyFile) : g._load(b.id, a.url, !!a.stream, !!a.autoPlay, a.loops || 1, !!a.autoLoad, a.usePolicyFile)
                    } catch (e) {
                        m("smError", 2),
                        y("onload", !1),
                        N({
            ...
            this.unload = function() {
                0 !== b.readyState && (c._wD('SMSound.unload(): "' + b.id + '"'),
                b.isHTML5 ? (h(),
                b._a && (b._a.pause(),
                Ba(b._a, "about:blank"),
                t = "about:blank")) : 8 === k ? g._unload(b.id, "about:blank") : g._unload(b.id),
                f());
                return b
            }
            ;
            this.destruct = function(a) {
                ...
                H || x(),
                b._a._s = null,
                b._a = null)) : (b._iO.onfailure = null,
                g._destroySound(b.id));
            ...
            this.start = this.play = function(a, d) {
                ...
                if (b._iO.serverURL && !b.connected)
                    return b.getAutoPlay() || (c._wD("SMSound.play():  Netstream not connected yet - setting autoPlay"),
                    b.setAutoPlay(!0)),
                    b;
                ma(b._iO) && (b._setup_html5(b._iO),
                i());
                1 === b.playState && !b.paused && ((e = b._iO.multiShot) ? c._wD('SMSound.play(): "' + b.id + '" already playing (multi-shot)', 1) : (c._wD('SMSound.play(): "' + b.id + '" already playing (one-shot)', 1),
                f = b));
                if (null !== f)
                    return f;
                a.url && a.url !== b.url && b.load(b._iO);
                b.loaded ? c._wD('SMSound.play(): "' + b.id + '"') : 0 === b.readyState ? (c._wD('SMSound.play(): Attempting to load "' + b.id + '"', 1),
                b.isHTML5 || (b._iO.autoPlay = !0),
                b.load(b._iO),
                b.instanceOptions = b._iO) : 2 === b.readyState ? (c._wD('SMSound.play(): Could not load "' + b.id + '" - exiting', 2),
                f = b) : c._wD('SMSound.play(): "' + b.id + '" is loading - attempting to play..', 1);
                if (null !== f)
                    return f;
                !b.isHTML5 && 9 === k && 0 < b.position && b.position === b.duration && (c._wD('SMSound.play(): "' + b.id + '": Sound at end, resetting to position:0'),
                a.position = 0);
                if (b.paused && 0 <= b.position && (!b._iO.serverURL || 0 < b.position))
                    c._wD('SMSound.play(): "' + b.id + '" is resuming from paused state', 1),
                    b.resume();
                else {
                    b._iO = w(a, b._iO);
                    if (null !== b._iO.from && null !== b._iO.to && 0 === b.instanceCount && 0 === b.playState && !b._iO.serverURL) {
                        ...
                        if (b.isHTML5 && !b._html5_canplay)
                            c._wD('SMSound.play(): Beginning load of "' + b.id + '" for from/to case'),
                            b.load({
                                oncanplay: e
                            }),
                            f = !1;
                        else if (!b.isHTML5 && !b.loaded && (!b.readyState || 2 !== b.readyState))
                            c._wD('SMSound.play(): Preloading "' + b.id + '" for from/to case'),
                            b.load({
                                onload: e
                            }),
                            f = !1;
                    ...
                    b._iO.onplay && d && (b._iO.onplay.apply(b),
                    q = !0);
                    b.setVolume(b._iO.volume, !0);
                    b.setPan(b._iO.pan, !0);
                    b.isHTML5 ? (i(),
                    f = b._setup_html5(),
                    b.setPosition(b._iO.position),
                    f.play()) : (f = g._start(b.id, b._iO.loops || 1, 9 === k ? b._iO.position : b._iO.position / 1e3, b._iO.multiShot),
                    9 === k && !f && (c._wD("SMSound.play(): " + b.id + ": No sound hardware, or 32-sound ceiling hit"),
                    b._iO.onplayerror && b._iO.onplayerror.apply(b)))
                }
                return b
            }
            ;
            this.stop = function(a) {
                var c = b._iO;
                1 === b.playState && (b._onbufferchange(0),
                b._resetOnPosition(0),
                b.paused = !1,
                b.isHTML5 || (b.playState = 0),
                u(),
                c.to && b.clearOnPosition(c.to),
                b.isHTML5 ? b._a && (a = b.position,
                b.setPosition(0),
                b.position = a,
                b._a.pause(),
                b.playState = 0,
            ...
            this.setAutoPlay = function(a) {
                ...
                b._iO.autoPlay = a;
                b.isHTML5 || (g._setAutoPlay(b.id, a),
                a && !b.instanceCount && 1 === b.readyState && (b.instanceCount++,
                c._wD("sound " + b.id + " incremented instance count to " + b.instanceCount)))
            }
            ;
                ...
                if (b.isHTML5) {
                    if (b._a)
                        if (b._html5_canplay) {
                            ...
                            c._wD("setPosition(" + a + "): delaying, sound not ready")
                } else
                    a = 9 === k ? b.position : a,
                    b.readyState && 2 !== b.readyState && g._setPosition(b.id, a, b.paused || !b.playState, b._iO.multiShot);
            ...
            this.pause = function(a) {
                ...
                h()) : (a || void 0 === a) && g._pause(b.id, b._iO.multiShot);
            ...
            this.resume = function() {
                ...
                b.paused = !1;
                b.playState = 1;
                b.isHTML5 ? (b._setup_html5().play(),
                i()) : (a.isMovieStar && !a.serverURL && b.setPosition(b.position),
                g._pause(b.id, a.multiShot));
                !q && a.onplay ? (a.onplay.apply(b),
                q = !0) : a.onresume && a.onresume.apply(b);
                return b
            }
            ;
            ...
            this.clearOnPosition = function(b, a) {
                ...
                for (c = 0; c < z.length; c++)
                    if (b === z[c].position && (!a || a === z[c].method))
                        z[c].fired && r--,
                        z.splice(c, 1)
            }
            ;
            this._processOnPosition = function() {
                var a, c;
                a = z.length;
                if (!a || !b.playState || r >= a)
                    return !1;
                for (a -= 1; 0 <= a; a--)
                    c = z[a],
                    !c.fired && b.position >= c.position && (c.fired = !0,
                    r++,
            ...
            this._resetOnPosition = function(b) {
                ...
                for (a -= 1; 0 <= a; a--)
                    c = z[a],
                    c.fired && b <= c.position && (c.fired = !1,
                    r--);
                return !0
            }
            ;
            v = function() {
                var a = b._iO, d = a.from, e = a.to, f, h;
                h = function() {
            ...
            this._setup_html5 = function(a) {
                var a = w(b._iO, a), c = decodeURI, d = H ? Ma : b._a, e = c(a.url), h;
                H ? e === Za && (h = !0) : e === t && (h = !0);
                if (d) {
                    if (d._s)
                        if (H)
                            d._s && d._s.playState && !h && d._s.stop();
                        else if (!H && e === c(t))
                            return b._apply_loop(d, a.loops),
                            d;
                    h || (f(!1),
                    d.src = a.url,
                    Za = t = b.url = a.url,
                    ...
                    m("h5a"),
                    b._a = a.autoLoad || a.autoPlay ? new Audio(a.url) : Ga && 10 > opera.version() ? new Audio(null) : new Audio,
                    d = b._a,
                    d._called_load = !1,
                    H && (Ma = d);
                b.isHTML5 = !0;
                ...
                a.autoLoad || a.autoPlay ? b.load() : (d.autobuffer = !1,
                d.preload = "auto");
                return d
            }
            ;
            j = function() {
                ...
                for (a in C)
                    C.hasOwnProperty(a) && b._a && b._a.addEventListener(a, C[a], !1);
                return !0
            }
            ;
            x = function() {
                ...
                for (a in C)
                    C.hasOwnProperty(a) && b._a && b._a.removeEventListener(a, C[a], !1)
            }
            ;
            this._onload = function(a) {
                a = !!a || !b.isHTML5 && 8 === k && b.duration;
                c._wD('SMSound._onload(): "' + b.id + '"' + (a ? " loaded." : " failed to load? - " + b.url), a ? 1 : 2);
                !a && !b.isHTML5 && (!0 === c.sandbox.noRemote && c._wD("SMSound._onload(): " + p("noNet"), 1),
                !0 === c.sandbox.noLocal && c._wD("SMSound._onload(): " + p("noLocal"), 1));
                b.loaded = a;
                b.readyState = a ? 3 : 2;
                b._onbufferchange(0);
            ...
            this._onbufferchange = function(a) {
                if (0 === b.playState || a && b.isBuffering || !a && !b.isBuffering)
                    return !1;
                b.isBuffering = 1 === a;
                b._iO.onbufferchange && (c._wD("SMSound._onbufferchange(): " + a),
                b._iO.onbufferchange.apply(b));
                return !0
            }
            ;
            this._onsuspend = function() {
                b._iO.onsuspend && (c._wD("SMSound._onsuspend()"),
                b._iO.onsuspend.apply(b));
                return !0
            }
            ;
            this._onfailure = function(a, d, e) {
                ...
                if (b._iO.onfailure && 1 === b.failures)
                    b._iO.onfailure(b, a, d, e);
                else
                    c._wD("SMSound._onfailure(): ignoring")
            }
            ;
            this._onfinish = function() {
                ...
                b._onbufferchange(0);
                b._resetOnPosition(0);
                if (b.instanceCount && (b.instanceCount--,
                b.instanceCount || (u(),
                b.playState = 0,
                b.paused = !1,
                b.instanceCount = 0,
                ...
                b._iO = {},
                h(),
                b.isHTML5 && (b.position = 0)),
                (!b.instanceCount || b._iO.multiShotEvents) && a))
                    c._wD('SMSound._onfinish(): "' + b.id + '"'),
                    a.apply(b)
            }
            ;
            ...
            this._whileplaying = function(a, c, d, e, f) {
                ...
                h.useEQData && void 0 !== f && f && f.leftEQ && (a = f.leftEQ.split(","),
                b.eqData = a,
                b.eqData.left = a,
                void 0 !== f.rightEQ && f.rightEQ && (b.eqData.right = f.rightEQ.split(","))));
                1 === b.playState && (!b.isHTML5 && 8 === k && !b.position && b.isBuffering && b._onbufferchange(0),
                h.whileplaying && h.whileplaying.apply(b));
                return !0
            }
            ;
            ...
            this._onconnect = function(a) {
                ...
                if (b.connected = a)
                    b.failures = 0,
                    s(b.id) && (b.getAutoPlay() ? b.play(void 0, b.getAutoPlay()) : b._iO.autoLoad && b.load()),
                    b._iO.onconnect && b._iO.onconnect.apply(b, [a])
            }
            ;
            this._ondataerror = function(a) {
                0 < b.playState && (c._wD("SMSound._ondataerror(): " + a),
                b._iO.ondataerror && b._iO.ondataerror.apply(b))
            }
        }
        ;
        fa = function() {
        ...
        w = function(a, d) {
            ...
            for (f in b)
                b.hasOwnProperty(f) && void 0 === e[f] && (e[f] = "object" !== typeof b[f] || null === b[f] ? b[f] : w(e[f], b[f]));
            return e
        }
        ;
        I = {
        ...
        ta = function(a, d) {
            var e, b = !0, f = void 0 !== d, g = c.setupOptions;
            if (void 0 === a) {
                b = [];
                for (e in g)
                    g.hasOwnProperty(e) && b.push(e);
                for (e in I)
                    I.hasOwnProperty(e) && ("object" === typeof c[e] ? b.push(e + ": {...}") : c[e]instanceof Function ? b.push(e + ": function() {...}") : b.push(e));
                c._wD(p("setup", b.join(", ")));
                return !1
            }
            for (e in a)
                if (a.hasOwnProperty(e))
                    if ("object" !== typeof a[e] || null === a[e] || a[e]instanceof Array)
                        f && void 0 !== I[d] ? c[d][e] = a[e] : void 0 !== g[e] ? (c.setupOptions[e] = a[e],
                        c[e] = a[e]) : void 0 === I[e] ? (P(p(void 0 === c[e] ? "setupUndef" : "setupError", e), 2),
                        b = !1) : c[e]instanceof Function ? c[e].apply(c, a[e]instanceof Array ? a[e] : [a[e]]) : c[e] = a[e];
                    else if (void 0 === I[e])
                        P(p(void 0 === c[e] ? "setupUndef" : "setupError", e), 2),
                        b = !1;
                    else
                        return ta(a[e], e);
            return b
            ...
            progress: q(function(a) {
                ...
                if (x && x.length) {
                    ...
                    if (g && 1 < x.length) {
                        ...
                        b = x.length;
                        for (e = 0; e < b; e++)
                            f.push(1e3 * a.target.buffered.start(e) + "-" + 1e3 * a.target.buffered.end(e));
                        c._wD(l + "progress: timeRanges: " + f.join(", "))
                    }
                    g && !isNaN(h) && c._wD(l + "progress: " + d.id + ": " + Math.floor(100 * h) + "% loaded")
                }
                isNaN(h) || (d._onbufferchange(0),
                d._whileloading(h, j, d._get_html5_duration()),
                h && j && h === j && C.canplaythrough.call(this, a))
            }),
        ...
        Z = function(a) {
            ...
            if (a && void 0 !== c.html5[a])
                return c.html5[a] && !aa(a);
            if (!E) {
                E = [];
                for (b in e)
                    e.hasOwnProperty(b) && (E.push(b),
                    e[b].related && (E = E.concat(e[b].related)));
                E = RegExp("\\.(" + E.join("|") + ")(\\?.*)?$", "i")
            }
            b = d ? d.toLowerCase().match(E) : null;
            !b || !b.length ? a && (d = a.indexOf(";"),
            b = (-1 !== d ? a.substr(0, d) : a).substr(6)) : b = b[1];
            b && void 0 !== c.html5[b] ? d = c.html5[b] && !aa(b) : (a = "audio/" + b,
        ...
        Xa = function() {
            function a(a) {
                ...
                if (a instanceof Array) {
                    ...
                    for (e = a.length; b < e; b++)
                        if (c.html5[a[b]] || d.canPlayType(a[b]).match(c.html5Test))
                            f = !0,
                            c.html5[a[b]] = !0,
                            c.flash[a[b]] = !!a[b].match(db);
                    b = f
                } else
            ...
            g = c.audioFormats;
            for (e in g)
                if (g.hasOwnProperty(e) && (b = "audio/" + e,
                f[e] = a(g[e].type),
                f[b] = f[e],
                e.match(db) ? (c.flash[e] = !0,
                c.flash[b] = !0) : (c.flash[e] = !1,
                c.flash[b] = !1),
                g[e] && g[e].related))
                    for (b = g[e].related.length - 1; 0 <= b; b--)
                        f["audio/" + g[e].related[b]] = f[e],
                        c.html5[g[e].related[b]] = f[e],
                        c.flash[g[e].related[b]] = f[e];
        ...
        p = function() {
            var a = Ya.call(arguments), c = a.shift(), c = da && da[c] ? da[c] : "", e, b;
            if (c && a && a.length) {
                e = 0;
        ...
        ;
        ia = function(a) {
            8 === k && 1 < a.loops && a.stream && (m("as2loop"),
            a.stream = !1);
            return a
        }
        ;
        ...
        Qa = function(a) {
            for (var c in a)
                a.hasOwnProperty(c) && "function" === typeof a[c] && (a[c] = qa)
        }
        ;
        ha = function(a) {
            void 0 === a && (a = !1);
        ...
        Ra = function(a) {
            ...
            if (a)
                if (a.match(/\.swf(\?.*)?$/i)) {
                    if (d = a.substr(a.toLowerCase().lastIndexOf(".swf?") + 4))
                        return a
                } else
        ...
        xa = function() {
            ...
            if (c.debugMode && !A(c.debugID) && (!bb || !c.useConsole || !c.consoleOnly)) {
                ...
                u.match(/msie 6/i) && (a.style.position = "absolute",
                a.style.cursor = "hand");
                for (b in d)
                    d.hasOwnProperty(b) && (a.style[b] = d[b]);
        ...
        Sa = function() {
            ...
            if (!a)
                return !1;
            sa ? (d.innerHTML = "+",
            a.style.display = "none") : (d.innerHTML = "-",
            a.style.display = "block");
            sa = !sa
        }
        ;
        y = function(a, c, e) {
            if (void 0 !== i.sm2Debugger)
                try {
        ...
        za = function() {
            ...
            if (c.html5Only)
                return !1;
            c.ok() ? (c.didFlashBlock && c._wD(a + ": Unblocked"),
            c.oMC && (c.oMC.className = [O(), "movieContainer", "swf_loaded" + (c.didFlashBlock ? " swf_unblocked" : "")].join(" "))) : (B && (c.oMC.className = O() + " movieContainer " + (null === d ? "swf_timedout" : "swf_error"),
            c._wD(a + ": " + p("fbTimeout") + (d ? " (" + p("fbLoaded") + ")" : ""))),
            c.didFlashBlock = !0,
            J({
                type: "ontimeout",
                ignoreInit: !0,
        ...
        J = function(a) {
            ...
            if (!n && a && !a.ignoreInit || "ontimeout" === a.type && (c.ok() || v && !a.ignoreInit))
                return !1;
            var d = {
                success: a && a.ignoreInit ? c.ok() : !v
            }, e = a && a.type ? D[a.type] || [] : [], b = [], f, g = [d], j = B && c.useFlashBlock && !c.ok();
            a.error && (g[0].error = a.error);
            d = 0;
            for (f = e.length; d < f; d++)
                !0 !== e[d].fired && b.push(e[d]);
            if (b.length) {
                c._wD("soundManager: Firing " + b.length + " " + a.type + "() item" + (1 === b.length ? "" : "s"));
                d = 0;
                for (f = b.length; d < f; d++)
                    b[d].scope ? b[d].method.apply(b[d].scope, g) : b[d].method.apply(this, g),
                    j || (b[d].fired = !0)
            }
            return !0
        }
        ...
        K = function() {
            i.setTimeout(function() {
                c.useFlashBlock && za();
                J();
                "function" === typeof c.onload && (m("onload", 1),
                c.onload.apply(i),
                m("onloadOK", 1));
        ...
        Wa = function() {
            ...
            if (Ea && u.match(/os (1|2|3_0|3_1)/i))
                c.hasHTML5 = !1,
                c.html5Only = !0,
            ...
            if (c.useHTML5Audio && c.hasHTML5)
                for (d in e)
                    if (e.hasOwnProperty(d) && (e[d].required && !c.html5.canPlayType(e[d].type) || c.preferFlash && (c.flash[d] || c.flash[e[d].type])))
                        a = !0;
            c.ignoreFlash && (a = !1);
        ...
        Ta = function(a) {
            ...
            !Ha && c.html5PollingInterval && (null === Y && 0 === ka && (Y = i.setInterval(Va, c.html5PollingInterval)),
            ka++))
        }
        ;
        Ua = function(a) {
            a._hasTimer && (a._hasTimer = !1,
            !Ha && c.html5PollingInterval && ka--)
        }
        ;
        Va = function() {
            var a;
            if (null !== Y && !ka)
                return i.clearInterval(Y),
                Y = null,
                !1;
            for (a = c.soundIDs.length - 1; 0 <= a; a--)
        ...
        $a = function() {
            ...
            for (e in a)
                if (a.hasOwnProperty(e) && ("mp3" === e || "mp4" === e))
                    ...
                    c.html5[e] = !1,
                    a[e] && a[e].related)
                        for (d = a[e].related.length - 1; 0 <= d; d--)
                            c.html5[a[e].related[d]] = !1
        }
        ;
        this._setSandboxType = function(a) {
            ...
            d.noLocal = !1,
            m("secNote", 2)) : "localWithNetwork" === d.type ? (d.noRemote = !1,
        ...
        this._externalInterfaceOK = function(a, d) {
            ...
            na = !1;
            Ia && $a();
            if (!d || d.replace(/\+dev/i, "") !== c.versionNumber.replace(/\+dev/i, ""))
                return e = 'soundManager: Fatal: JavaScript file build "' + c.versionNumber + '" does not match Flash SWF build "' + d + '" at ' + c.url + ". Ensure both are up-to-date.",
                setTimeout(function() {
                    throw Error(e)
                }, 0),
                !1;
        ...
        ga = function(a, d) {
            ...
            if (null !== c.wmode && (u.match(/msie 8/i) || !F && !c.useHighPerformance) && navigator.platform.match(/win32|win64/i))
                m("spcWmode"),
                c.wmode = null;
            i = {
                name: a,
            ...
            if (F)
                f = j.createElement("div"),
                q = ['<object id="' + a + '" data="' + d + '" type="' + i.type + '" title="' + i.title + '" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="' + eb + 'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0">', b("movie", d), b("AllowScriptAccess", c.allowScriptAccess), b("quality", i.quality), c.wmode ? b("wmode", c.wmode) : "", b("bgcolor", c.bgColor), b("hasPriority", "true"), c.debugFlash ? b("FlashVars", i.FlashVars) : "", "</object>"].join("");
            else
                for (l in f = j.createElement("embed"),
                i)
                    i.hasOwnProperty(l) && f.setAttribute(l, i[l]);
            xa();
            h = O();
            if (i = fa())
                if (c.oMC = A(c.movieID) || j.createElement("div"),
                c.oMC.id)
                    n = c.oMC.className,
                    c.oMC.className = (n ? n + " " : "movieContainer") + (h ? " " + h : ""),
                    c.oMC.appendChild(f),
                    F && (l = c.oMC.appendChild(j.createElement("div")),
                    ...
                    if (!c.debugFlash)
                        for (n in h)
                            h.hasOwnProperty(n) && (c.oMC.style[n] = h[n]);
                    try {
                        F || c.oMC.appendChild(f),
                        i.appendChild(c.oMC),
                        F && (l = c.oMC.appendChild(j.createElement("div")),
                        l.className = "sm2-object-box",
                        l.innerHTML = q),
        ...
        ea = function() {
            ...
            if (!c.url)
                ...
                !1;
            g = c.getMovie(c.id);
            g || (W ? (F ? c.oMC.innerHTML = ya : c.oMC.appendChild(W),
            W = null,
            S = !0) : ga(c.id, c.url),
            g = c.getMovie(c.id));
            g && m("waitEI");
        ...
        Oa = function() {
            ...
            if (na && !Ja)
                return m("waitFocus"),
                !1;
            n || (a = c.getMoviePercent(),
            c._wD(p("waitImpatient", 0 < a ? " (SWF " + a + "% loaded)" : "")),
            0 < a && 100 > a && (d = !0));
            setTimeout(function() {
                a = c.getMoviePercent();
                if (d)
                    ...
                    i.setTimeout(L, 1),
                    !1;
                n || (c._wD("soundManager: No Flash response within expected time.\nLikely causes: " + (0 === a ? "Loading " + c.movieURL + " may have failed (and/or Flash " + k + "+ not present?), " : "") + "Flash blocked or JS-Flash security error." + (c.debugFlash ? " " + p("checkSWF") : ""), 2),
                !Q && a && (m("localFail", 2),
                c.debugFlash || m("tryDebug", 2)),
                0 === a && c._wD(p("swf404", c.url)),
                y("flashtojs", !1, ": Timed out" + Q ? " (Check flash security or flash blockers)" : " (No plugin/missing SWF?)"));
                !n && cb && (null === a ? c.useFlashBlock || 0 === c.flashLoadTimeout ? (c.useFlashBlock && za(),
                m("waitForever")) : ha(!0) : 0 === c.flashLoadTimeout ? m("waitForever") : ha(!0))
            }, c.flashLoadTimeout)
        }
        ;
        ca = function() {
            if (Ja || !na)
                return r.remove(i, "focus", ca),
                !0;
            Ja = cb = !0;
            m("gotFocus");
            X = !1;
        ...
        ab = function() {
            ...
            if (c.useHTML5Audio && c.hasHTML5) {
                for (a in c.audioFormats)
                    c.audioFormats.hasOwnProperty(a) && d.push(a + ": " + c.html5[a] + (!c.html5[a] && t && c.flash[a] ? " (using flash)" : c.preferFlash && c.flash[a] && t ? " (preferring flash)" : !c.html5[a] ? " (" + (c.audioFormats[a].required ? "required, " : "") + "and no flash support)" : ""));
        ...
        U = function(a) {
            if (n)
                return !1;
            if (c.html5Only)
                return c._wD("-- SoundManager 2: loaded --"),
                n = !0,
                K(),
                y("onload", !0),
                !0;
            ...
            v || a ? (c.useFlashBlock && c.oMC && (c.oMC.className = O() + " " + (null === c.getMoviePercent() ? "swf_timedout" : "swf_error")),
            J({
                type: "ontimeout",
                error: e,
                ignoreInit: !0
            ...
            N(e),
            d = !1) : y("onload", !0);
            v || (c.waitForWindowLoad && !ba ? (m("waitOnload"),
            r.add(i, "load", K)) : (c.waitForWindowLoad && ba && m("docLoaded"),
            K()));
            return d
        }
        ;
        Na = function() {
            ...
            for (a in d)
                d.hasOwnProperty(a) && (void 0 === c[a] ? c[a] = d[a] : c[a] !== d[a] && (c.setupOptions[a] = c[a]))
        }
        ;
        ra = function() {
            m("init");
            if (n)
                ...
                !1;
            if (c.html5Only)
                return n || (r.remove(i, "load", c.beginDelayedInit),
                c.enabled = !0,
                U()),
                !0;
            ea();
            try {
                m("flashJS"),
                g._externalInterfaceTest(!1),
                Pa(!0, c.flashPollingInterval || (c.useHighPerformance ? 10 : 50)),
                c.debugMode || g._disableDebug(),
                c.enabled = !0,
                y("jstoflash", !0),
                c.html5Only || r.add(i, "unload", qa)
            } catch (a) {
                return c._wD("js/flash exception: " + a.toString()),
                y("jstoflash", !1),
                N({
        ...
        M = function() {
            ...
            var a = null
              ...
              , e = R.toLowerCase();
            -1 !== e.indexOf("sm2-usehtml5audio=") && (a = "1" === e.charAt(e.indexOf("sm2-usehtml5audio=") + 18),
            d && console.log((a ? "Enabling " : "Disabling ") + "useHTML5Audio via URL parameter"),
            c.setup({
                useHTML5Audio: a
            }));
            -1 !== e.indexOf("sm2-preferflash=") && (a = "1" === e.charAt(e.indexOf("sm2-preferflash=") + 16),
            d && console.log((a ? "Enabling " : "Disabling ") + "preferFlash via URL parameter"),
            c.setup({
                preferFlash: a
            }));
            !t && c.hasHTML5 && (c._wD("SoundManager: No Flash detected" + (!c.useHTML5Audio ? ", enabling HTML5." : ". Trying HTML5-only mode.")),
            c.setup({
                useHTML5Audio: !0,
                preferFlash: !1
            }));
        ...
        Ca = function() {
            ...
            j.detachEvent("onreadystatechange", Ca));
            return !0
        }
        ;
        wa = function() {
        ...
        r.add(i, "load", L);
        r.add(i, "load", wa);
        j.addEventListener ? j.addEventListener("DOMContentLoaded", M, !1) : j.attachEvent ? j.attachEvent("onreadystatechange", Ca) : (y("onload", !1),
        N({
            type: "NO_DOM2_EVENTS",
            fatal: !0
        }))
    ...
    var pa = null;
    if (void 0 === G.SM2_DEFER || !SM2_DEFER)
        pa = new $;
    G.SoundManager = $;
    G.soundManager = pa
})(window);
...
var OFFSET_LEFT, OFFSET_TOP, PieRender, Sound, any_in_object, app, assign, bound, classroom_tmpl, clone, color_from_hue, distance, enclose, find_first, find_hash_key, gamecounter, message_tmpl, rand, rand_between, remove, rgb_to_hex, role_info_tmpl, slice = [].slice, indexOf = [].indexOf || function(item) {
...
remove = function(arr, e) {
    ...
    if ((t = arr.indexOf(e)) > -1) {
        return [].splice.apply(arr, [t, t - t + 1].concat(ref = [])),
        ref
    }
}
;
...
assign = function() {
    var k, l, len, source, sources, target, v;
    target = arguments[0],
    sources = 2 <= arguments.length ? slice.call(arguments, 1) : [];
    for (l = 0,
    len = sources.length; l < len; l++) {
        source = sources[l];
        for (k in source) {
            v = source[k];
            target[k] = v
...
;
find_first = function(arr, cb) {
    var a, l, len;
    for (l = 0,
    len = arr.length; l < len; l++) {
        a = arr[l];
        if (cb(a)) {
            return a
        }
...
window.rainbownize = function(text) {
    ...
    msg = function() {
        ...
        results = [];
        for (i = l = 0,
        ref = text.length; 0 <= ref ? l <= ref : l >= ref; i = 0 <= ref ? ++l : --l) {
...
app.controller("GameCtrl", ["$scope", "$http", "$window", "$document", "$timeout", "socket", "$filter", "$cookieStore", function($scope, $http, $window, $document, $timeout, socket, $filter, $cookieStore) {
    var add_cmd, base, cmds, gamecmd_map, get_night_music_id, highlight_speech, init_player_and_users, k, night_music_map, play_background_music, ref, stop_night_music, transform_cmd, transform_shorten, unwrap_canvas_data, v;
    cmds = {};
    add_cmd = function(_this) {
    ...
    $scope.settings = {
        ...
        mutemusic: false,
        speechfilter: false,
        mutedeathsounds: false
    };
    $scope.highlighted_users = {};
    highlight_speech = function() {
        var checked, highlighted, k, l, len, player, results, talks;
        checked = function() {
            var ref, results;
            ref = $scope.highlighted_users;
            results = [];
            for (k in ref) {
                highlighted = ref[k];
                if (highlighted) {
        ...
        talks = $(".talk");
        if (!$scope.settings.speechfilter || checked.length === 0) {
            return talks.css("opacity", "1")
        } else {
            talks.css("opacity", "0.25");
            results = [];
            for (l = 0,
            len = checked.length; l < len; l++) {
                player = checked[l];
                results.push(talks.has("[value='" + player + "']").css("opacity", "1"))
            }
            return results
        }
    }
    ;
    $scope.filter_speech = function(user) {
        $scope.highlighted_users[user.username] = !$scope.highlighted_users[user.username];
        highlight_speech()
    }
    ;
    $scope.settings_fnc = {
    ...
    night_music_map = {
        role: {
            fiddler: "night:fiddler",
            clockmaker: "night:clockmaker",
            snowman: "night:winter",
            santa: "night:winter",
            caroler: "night:winter",
            sheriff: "night:western",
            deputy: "night:western",
            doctor: "night:medical",
            surgeon: "night:medical",
            survivor: "night:jungle",
            nomad: "night:jungle",
            butterfly: "night:jungle",
            monkey: "night:jungle",
            hunter: "night:jungle",
            huntsman: "night:jungle",
            governor: "night:government",
            president: "night:government",
            judge: "night:government",
            leader: "night:government",
            justice: "night:government",
            secretary: "night:government",
            politician: "night:government",
            lover: "night:love",
            angel: "night:love",
            cupid: "night:love",
            siren: "night:love",
            bride: "night:love",
            cop: "night:investigator",
            detective: "night:investigator",
            journalist: "night:investigator",
            snoop: "night:investigator",
            watcher: "night:investigator",
            tracker: "night:investigator"
        },
        align: {
            mafia: "night:mafia"
        }
    };
    get_night_music_id = function() {
        var align, align_music_map, me, ref, role, role_music_map;
        me = (ref = $scope.current_users) != null ? ref[$scope.user] : void 0;
        role = me != null ? me.role : void 0;
        align = $window.role_data[role];
        role_music_map = night_music_map.role;
        align_music_map = night_music_map.align;
        return role_music_map[role] || align_music_map[align] || "night"
    }
    ;
    stop_night_music = function() {
        var k, kk, l, len, ref, results, sound_id, sounds, v;
        sounds = ["night"];
        for (k in night_music_map) {
            v = night_music_map[k];
            for (kk in v) {
                sound_id = v[kk];
        ...
        results = [];
        for (l = 0,
        len = sounds.length; l < len; l++) {
            sound_id = sounds[l];
            results.push((ref = $window.sound.sounds[sound_id]) != null ? ref.stop() : void 0)
        }
        return results
    }
    ;
    play_background_music = function() {
        ...
        if ($scope.current_state > 0) {
            if ($scope.current_state % 2 === 0) {
                ...
                night_id = get_night_music_id();
                return $window.sound.play(night_id, {
                    loop: 100
                })
            }
        }
    ...
    $scope.$watch("kicks_needed", function() {
        ...
        $scope.kicks_html = function() {
            ...
            results = [];
            for (i = l = 1,
            ref = $scope.kicks_needed; 1 <= ref ? l <= ref : l >= ref; i = 1 <= ref ? ++l : --l) {
                results.push({
                    html: "&#10006;"
                })
            }
    ...
    $scope.toggle_setting = function(setting) {
		...
		document.body.dispatchEvent(new Event("mafiaGameSettings"));
    }
    ;
    ref = $scope.settings;
    for (k in ref) {
    ...
    $scope.init_user = function(u) {
        ...
        if (u.deathsound) {
            data = {};
            data["deathsound:" + u.username] = {
                file: "/uploads/deathsounds/" + u.deathsound,
                volume: 100
            };
            window.sound.load_data(data)
        }
        if (u.emotes) {
            try {
    ...
    $scope.reset_speak = function() {
        ...
        results = [];
        for (l = 0,
        len = speak_types.length; l < len; l++) {
    ...
    $scope.execute_cmds = function(_this) {
        return function(pkg) {
            ...
            for (l = 0,
            len = pkg.length; l < len; l++) {
                p = pkg[l];
                if (p) {
                    ref1 = transform_cmd.apply(null, p),
                    cmd = ref1[0],
                    params = ref1[1];
    ...
    $scope.goto_state = function(state) {
        ...
        $scope.create_links(state);
        return setTimeout(function() {
            return highlight_speech()
        }, 0)
    }
    ;
    ...
    $scope.process_cmd = function(_this) {
        return function(cmd, a) {
            ...
            case "disguise":
                ...
                for (k in ref3) {
                    v = ref3[k];
                    ref4 = [$scope.current_users[v].status, $scope.current_users[k].status],
                    $scope.current_users[k].status = ref4[0],
                    $scope.current_users[v].status = ref4[1];
                    if ($scope.user === k) {
                        $scope.user = v
                    }
                    if ($scope.user === v) {
            ...
            case "<":
                ...
                if (!$window.in_window && m.match(new RegExp("\\b" + $scope.user + "\\b","ig"))) {
                    $window.sound.play("ding");
                    $window.flasher.remind(a.user + " mentioned you!")
                }
                return highlight_speech();
            case "countdown":
                $scope.kick_state = 1;
            ...
            case "inputed":
                return $scope.modify_html("cmds", function(el) {
                    var boxes, item, ref7, results1, search_boxes;
                    ref7 = a.data;
                    results1 = [];
                    for (k in ref7) {
                        v = ref7[k];
                        ...
                        item = item.replace(/~/g, " ");
                        search_boxes = ["#meetbox_" + a.meet + " #inputbox_" + a.inputname + "_" + a.id + " #inputed_" + a.inputname + "_" + k + "_" + a.user, "#meetbox_" + a.meet + " #inputbox_" + a.inputname + " #inputed_" + a.inputname + "_" + k + "_" + a.user];
                        boxes = search_boxes.map(function(str) {
                            return el.find(str)
                        });
                        match = find_first(boxes, function(box) {
                            return box.length > 0
                        });
                        if (item === "*") {
                            item = "no one"
                        ...
                        if (match) {
                            results1.push(match.text("choose " + item))
                        } else {
            ...
            case "round":
                ...
                if ($scope.users) {
                    ref7 = $scope.users;
                    for (user = s = 0,
                    len2 = ref7.length; s < len2; user = ++s) {
                        k = ref7[user];
                        user.chatting = false
                    }
                }
            ...
            case "meet":
                ...
                $scope.modify_html("cmds", function(el) {
                    ...
                    el.append(a.data);
                    if ($scope.spectate || $scope.mentor || $scope.dead || (ref8 = $scope.user,
                    indexOf.call(a.non_voting || [], ref8) >= 0)) {
                ...
                if (a.say && a.members.length > 1 && ((ref8 = $scope.user,
                indexOf.call(a.members, ref8) >= 0) || ((ref9 = a.disguise) != null ? ref9[$scope.user] : void 0))) {
                    $scope.can_speak = true;
                    ...
                    members_without_self = function() {
                        ...
                        results1 = [];
                        for (z = 0,
                        len3 = members_without_self.length; z < len3; z++) {
            ...
            case "kill":
                ...
                if (!(!$scope.executed_cmds || $scope.settings.mutedeathsounds)) {
                    $window.sound.queue("deathsounds", "deathsound:" + a.target, 5e3)
                }
            ...
            case "k":
                if (user = $scope.current_users[a.user]) {
            ...
            case "cam_init":
                if (!!getUserMedia) {
                    ...
                    alert("Your browser does not support cam. Please use the latest Chrome or Firefox!");
                    return
                }
                if (window.development) {
                    rtc.debug = true
                }
                socket.add_cmd = add_cmd;
                rtc.connect(socket);
                rtc.createStream({
                    video: true,
                    audio: true
                ...
                return rtc.on("add remote stream", function(stream, id) {
                    ...
                    $("#remote_videos").append("<video id='remote_video_" + id + "' class='tt' data-type='userinfo' data-align='bottom' data-uid='" + id + "' style='height:80px;'></video>");
            ...
            case "kudo_karma":
                return $.getJSON("/game/" + $scope.game_id + "/kudo_karma", function(o) {
                    ...
                    data = o[1];
                    if (status) {
                        return $window.fetch_template("game_kudo.html?2", "game_kudo", function(tmpl) {
                            $scope.modify_html("cmds", function(el) {
                                return $scope.$apply(function() {
            ...
            case "win":
                if (!$scope.settings.mutemusic) {
                    return $window.sound.queue("win", a.party)
                }
            }
        }
    }(this);
...
Sound = function() {
    function Sound() {
        var l, len, len1, night_sound, night_sounds, q, win_sound, win_sounds;
        ...
        win_sounds = ["alien", "anarchist", "angel", "autocrat", "clockmaker", "creepygirl", "cultist", "cupid", "fool", "killer", "lover", "lyncher", "gambler", "mafia", "mastermind", "mistletoe", "monk", "noone", "prophet", "sidekick", "siren", "survivor", "village", "warlock", "werewolf", "zombie"];
        for (l = 0,
        len = win_sounds.length; l < len; l++) {
            win_sound = win_sounds[l];
            this.data[win_sound] = {
                file: "/sounds/win/" + win_sound + ".mp3",
                volume: 60
            }
        }
        night_sounds = ["fiddler", "clockmaker", "winter", "western", "mafia", "medical", "government", "jungle", "love", "investigator"];
        for (q = 0,
        len1 = night_sounds.length; q < len1; q++) {
            night_sound = night_sounds[q];
            this.data["night:" + night_sound] = {
                file: "/sounds/night/" + night_sound + ".mp3",
                volume: 60
            }
        }
    ...
    Sound.prototype.load_data = function(obj) {
        return assign(this.data, obj)
    }
    ;
    Sound.prototype.play = function(sound, options) {
        ...
        if (this.soundready) {
            ...
            if (this.sounds[sound] != null) {
                return this.sounds[sound].play(options)
            }
        } else {
            return setTimeout(function(_this) {
                return function() {
                    return _this.play(sound, options)
                }
            }(this), 1e3)
        }
    }
    ;
    Sound.prototype.queue = function(id, sound, timeout) {
        var base, queue;
        if (this.data[sound] == null) {
            return false
        }
        (base = this.queues)[id] || (base[id] = {
            state: 0,
            list: []
        });
        ...
        return this.check_queue(id, timeout)
    }
    ;
    Sound.prototype.check_queue = function(id) {
        var check_next, completed, list, ref, sound, sound_data, state, timeout, timeout_obj;
        if (!this.queues[id]) {
            return
        }
        ref = this.queues[id],
        list = ref.list,
        state = ref.state;
        if (state === 0 && list.length) {
            sound_data = list.shift();
            sound = sound_data.sound,
            timeout = sound_data.timeout;
            this.queues[id].state = 1;
            completed = false;
            timeout_obj = null;
            check_next = function(_this) {
                return function() {
                    _this.queues[id].state = 0;
                    return _this.check_queue(id)
                }
            }(this);
            return this.play(sound, {
                onplay: function(_this) {
                    return function() {
                        ...
                        return timeout_obj = setTimeout(function() {
                            if (completed) {
                                return
                            }
                            completed = true;
